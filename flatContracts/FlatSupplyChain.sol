...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, RetailerRole, ConsumerRole{
  ...
  // THIS ALREADY EXISTS IN Ownable.sol
  modifier onlyOwner() {
  ...
  function processItem(uint _upc) public
    // Call Mmodifier to check if farmer is calling the function
    onlyFarmer
  ...
  function buyItem(uint _upc) public payable
    // Call Mmodifier to check if Distributor is calling the function
    onlyDistributor
    // Call modifier to check if upc has passed previous supply chain stage
    forSale(_upc)
  ...
  // Changed itemState input parameter to type State
